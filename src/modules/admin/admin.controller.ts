...
const adminController = {
	users: {
		getUsers: async (req: Request, res: Response, next: NextFunction) => {
			...
			const me = await usersService.getMyData(userId)
			if (me.role !== 'admin') {
      ...
      const user = await adminService.users.updateUserById(req.params.userId, req.body)
      res.status(200).json({ data: user })
		},
		...
		getUserGiftById: async (
			...
			const user = await adminService.users.getUserGiftsById(req.params.userId, req.params.giftId)
			res.status(200).json({ data: user })
		},
	...
	messages: {
      ...
      const message = await adminService.messages.getMessageById(req.params.messageId)
      ...
      const message = await adminService.messages.updateMessageById(req.params.messageId, req.body)
      res.status(200).json({ data: message })
		},
      ...
      const message = await adminService.messages.deleteMessageById(req.params.messageId)
      res.status(200).json({ data: message })
		},
	},
	gifts: {
      ...
      const gift = await adminService.gifts.updateGiftById(req.params.giftId, req.body)
      res.status(200).json({ data: gift })
		},
	...
	emojis: {
      ...
      const emoji = await adminService.emojis.updateEmojiById(req.params.emojiId, req.body)
      res.status(200).json({ data: emoji })
		},
      ...
      const emoji = await adminService.emojis.deleteEmojiById(req.params.emojiId)
      res.status(200).json({ data: emoji })
		},
	},
}
